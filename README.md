...
v0.8.5.2은 설정 탭에 국내 일봉 차트 갱신(KIS) 메뉴를 복구한 버전이다. Apps Script에는 refreshKrxDailyCharts action 추가가 필요하다.
...
- 2026-06-07 : fix: 프로젝트 버전 v0.8.5.2 동기화 및 README 규격 정립

- 2026-06-07 : [v0.8.5.2] readme 최종 규격 강제 정렬